...
def plot_combined_waveform(analyzer1, analyzer2, analyzer3, analyzer4, analyzer5, 
    ...
    try:
        ...
        # 绘制第三个分析器的数据（蓝色）
        ax10 = analyzer9.plot_waveform(color="#000000", label=f"{analyzer10.file_path.name}", ax=ax, base_intervals = [
        (173.0, 383.0),
        (450.0, 660.0),
        (686.0, 896.0),
        (966.0, 1176.0)
        ...
        # 绘制第三个分析器的数据（蓝色）
        ax11 = analyzer9.plot_waveform(color="#FFFB80", label=f"{analyzer11.file_path.name}", ax=ax, base_intervals = [
        (173.0, 383.0),
        (450.0, 660.0),
        (686.0, 896.0),
        (966.0, 1176.0)
        ...
        # 绘制第三个分析器的数据（蓝色）
        ax12 = analyzer9.plot_waveform(color="#80FFB9", label=f"{analyzer12.file_path.name}", ax=ax, base_intervals = [
        (173.0, 383.0),
        (450.0, 660.0),
        (686.0, 896.0),
        (966.0, 1176.0)
...
def main():
    try:
        analyzer1 = DataAnalyzer("2_empty_2.bin")
        analyzer2 = DataAnalyzer("2_0_2.bin")
        analyzer3 = DataAnalyzer("2_03_2.bin")
        analyzer4 = DataAnalyzer("2_05_2.bin")
        analyzer5 = DataAnalyzer("2_3_2.bin")
        analyzer6 = DataAnalyzer("2_5_2.bin")
        analyzer7 = DataAnalyzer("2_10_2.bin")
        analyzer8 = DataAnalyzer("2_13_2.bin")
        analyzer9 = DataAnalyzer("2_20_2.bin")
        analyzer10 = DataAnalyzer("2_27_2.bin")
        analyzer11 = DataAnalyzer("2_33_2.bin")
        analyzer12 = DataAnalyzer("2_3534_2.bin")
