...
def main():
    try:
        ...
        analyzer2 = DataAnalyzer("4in1/7.bin")
        analyzer3 = DataAnalyzer("4in1/1.bin")
        analyzer4 = DataAnalyzer("4in1/7.bin")
        analyzer5 = DataAnalyzer("4in1/1.bin")
        analyzer6 = DataAnalyzer("4in1/7.bin")
        analyzer7 = DataAnalyzer("4in1/1.bin")
        analyzer8 = DataAnalyzer("4in1/7.bin")
        analyzer9 = DataAnalyzer("4in1/1.bin")
        analyzer10 = DataAnalyzer("4in1/7.bin")
