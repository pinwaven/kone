...
def main():
    try:
        # analyzer1 = DataAnalyzer("35_4.bin")
        # analyzer2 = DataAnalyzer("35_6.bin")
        # analyzer3 = DataAnalyzer("35_8.bin")
        # analyzer4 = DataAnalyzer("35_10.bin")
        # analyzer5 = DataAnalyzer("35_12.bin")

        # analyzer1 = DataAnalyzer("d_4.bin")
        # analyzer2 = DataAnalyzer("d_6.bin")
        # analyzer3 = DataAnalyzer("d_8.bin")
        # analyzer4 = DataAnalyzer("d_10.bin")
        # analyzer5 = DataAnalyzer("d_12.bin")

        analyzer1 = DataAnalyzer("d_12.bin")
        analyzer2 = DataAnalyzer("d_12_2.bin")
        analyzer3 = DataAnalyzer("d_12_3.bin")
        analyzer4 = DataAnalyzer("d_12_4.bin")
        analyzer5 = DataAnalyzer("d_12.bin")
