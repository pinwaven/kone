...
def main():
    try:
        # analyzer = DataAnalyzer("1.bin")
        # analyzer = DataAnalyzer("3.bin")
        analyzer = DataAnalyzer("base2.bin")
        # analyzer = DataAnalyzer("data_pin3.bin")
        # analyzer = DataAnalyzer("data_empty.bin")
        # analyzer = DataAnalyzer("data_manson1.bin")
        # analyzer = DataAnalyzer("data_manson3.bin")
        # analyzer = DataAnalyzer("data_manson3_1.bin")
        # analyzer = DataAnalyzer("data_manson3_2.bin")
        # analyzer = DataAnalyzer("data_leo3.bin")
        # analyzer = DataAnalyzer("4in1_base.bin")
        # analyzer = DataAnalyzer("4in1.bin")
        # analyzer = DataAnalyzer("4in1_full.bin")
        # analyzer = DataAnalyzer("4in1_v2.bin")
        # analyzer = DataAnalyzer("4in1/3.bin")
        # analyzer = DataAnalyzer("2in1/1_4.bin")
        # analyzer = DataAnalyzer("2in1/1.bin")
        # analyzer = DataAnalyzer("3in1/3in1.bin")
