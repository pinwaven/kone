...
def plot_combined_waveform(analyzer1, analyzer2, analyzer3, analyzer4, analyzer5):
    ...
    try:
        ...
        # 绘制第一个分析器的数据（蓝色）
        ax1 = analyzer1.plot_waveform(color='#FF0000', label=f"{analyzer1.file_path.name}", ax=ax,mark_points=[450, 660])
        
        # 绘制第二个分析器的数据（红色）
        ax2 = analyzer2.plot_waveform(color='#008000', label=f"{analyzer2.file_path.name}", ax=ax, mark_points=[450, 660])
        
        # 绘制第三个分析器的数据（蓝色）
        ax3 = analyzer3.plot_waveform(color='#0000FF', label=f"{analyzer3.file_path.name}", ax=ax, mark_points=[450, 660])
        
        # 绘制第四个分析器的数据（红色）
        ax4 = analyzer4.plot_waveform(color='#FFA500', label=f"{analyzer4.file_path.name}", ax=ax, mark_points=[450, 660])
        
        # 绘制第一个分析器的数据（蓝色）
        ax5 = analyzer5.plot_waveform(color='#800080', label=f"{analyzer5.file_path.name}", ax=ax, mark_points=[450, 660])
...
def main():
    try:
        # analyzer1 = DataAnalyzer("d_M_4.bin")
        # analyzer2 = DataAnalyzer("d_M_4.bin")
        # analyzer3 = DataAnalyzer("d_M_4.bin")
        # analyzer4 = DataAnalyzer("d_M_6.bin")
        # analyzer5 = DataAnalyzer("d_M_6.bin")

        # analyzer1 = DataAnalyzer("d_L_4.bin")
        # analyzer2 = DataAnalyzer("d_L_4.bin")
        # analyzer3 = DataAnalyzer("d_L_4.bin")
        # analyzer4 = DataAnalyzer("d_L_6.bin")
        # analyzer5 = DataAnalyzer("d_L_6.bin")

        analyzer1 = DataAnalyzer("d_M_4.bin")
        analyzer2 = DataAnalyzer("d_M_6.bin")
        analyzer3 = DataAnalyzer("d_M_4_2.bin")
        analyzer4 = DataAnalyzer("d_M_6_2.bin")
        analyzer5 = DataAnalyzer("d_M_4_3.bin")

        analyzer1 = DataAnalyzer("d_M_6_3.bin")
        analyzer2 = DataAnalyzer("d_M_4.bin")
        analyzer3 = DataAnalyzer("d_M_6.bin")
        analyzer4 = DataAnalyzer("d_M_4_2.bin")
        analyzer5 = DataAnalyzer("d_M_6_2.bin")
