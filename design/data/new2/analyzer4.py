...
def main():
    try:
        ...
        # analyzer2 = DataAnalyzer("d_8.bin")
        # analyzer3 = DataAnalyzer("d_12.bin")
        # analyzer4 = DataAnalyzer("d_16.bin")
        # analyzer5 = DataAnalyzer("30_4.bin")
        # analyzer6 = DataAnalyzer("35_8.bin")
        # analyzer7 = DataAnalyzer("35_12.bin")
        # analyzer8 = DataAnalyzer("30_16.bin")
        # analyzer9 = DataAnalyzer("empty.bin")

        # analyzer1 = DataAnalyzer("d_4.bin")
        # analyzer2 = DataAnalyzer("35_12-25_2.bin")
        # # analyzer2 = DataAnalyzer("d_4-50.bin")
        # analyzer3 = DataAnalyzer("d_4-45.bin")
        # analyzer4 = DataAnalyzer("d_4-40.bin")
        # analyzer5 = DataAnalyzer("d_4-35.bin")
        # analyzer6 = DataAnalyzer("d_4-30.bin")
        # analyzer7 = DataAnalyzer("d_4-25.bin")
        # analyzer8 = DataAnalyzer("35_12-25.bin")
        # analyzer9 = DataAnalyzer("d_0-25.bin")

        analyzer1 = DataAnalyzer("35341_1.bin")
        analyzer2 = DataAnalyzer("35341_2.bin")
        analyzer3 = DataAnalyzer("35341_3.bin")
        analyzer4 = DataAnalyzer("35341_4.bin")
        analyzer5 = DataAnalyzer("35341_5.bin")
        analyzer6 = DataAnalyzer("35341_6.bin")
        analyzer7 = DataAnalyzer("35341_7.bin")
        analyzer8 = DataAnalyzer("35341_8.bin")
        analyzer9 = DataAnalyzer("empty.bin")
